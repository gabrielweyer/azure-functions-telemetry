...
I used the Azure Functions Core Tools version `3.0.3160` to create the Function App (released on the 9th of December 2020). The latest version of the Azure Functions Core Tools I've been using is `3.0.3904`.

NuGet packages:

- `Microsoft.NET.Sdk.Functions`: `3.0.13` (added automatically when creating the Function, updated later)
...
- `Microsoft.Extensions.DependencyInjection`: `3.1.22` (added manually following [Use dependency injection in .NET Azure Functions][dependency-injection])
